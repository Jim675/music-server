 ...
 * @description: 主页
 * @author: qw Lu
 * @date: 2023-03-07 23:40:40
-->

<template>
  <!--轮播图 interval="4000"间隔4000ms-->
  ...
  <!--热门歌单 playList==play-list -->
  <playList class="play-list-container" title="热门歌单" path="song-sheet-detail" :playList="songList"></playList>
  <!--热门歌手-->
  <play-list class="play-list-container" title="热门歌手" path="singer-detail" :playList="singerList"></play-list>
</template>

<!-- vue3语法糖,里面不用写setup,也不用手动写return -->
