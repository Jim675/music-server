<!--
 * @description: 控制音乐播放功能的组件
 * @author: qw Lu
 * @date: 2023-03-02 22:17:15
-->

<template>
  <audio  :src="attachImageUrl(songUrl)" :ref="player" preload="true" @canplay="canplay" @timeupdate="timeupdate" @ended="ended">
    <!--（1）属性：controls，preload（2）事件：canplay，timeupdate，ended（3）方法：play()，pause() `controls="controls"`-->
