...
public class Constants {
    ...
    public static String LOCAL_PATH = "file:" + System.getProperty("user.dir");
    public static String CLOUD_PATH = "https://lqw675.oss-cn-chengdu.aliyuncs.com";
    public static String PROJECT_PATH = CLOUD_PATH;
...
//    public static String BANNER_PIC_PATH = "file:" + PROJECT_PATH + "/img/swiper/";
    ...
    public static String BANNER_PIC_PATH = PROJECT_PATH + "/img/swiper/";
